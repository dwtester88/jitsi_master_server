    ...
    extends MainMenuActivity
{
    ...
    private void handleIntent(Intent intent, Bundle savedInstanceState)
    {
        ...
        logger.info("Jitsi class action Intent "
        ...
        if(savedInstanceState != null)
        {
            ...
            logger.info("Jitsi class savedInstanceState not null ");

            return;
        }

        logger.info("Jitsi class savedInstanceState null "
               );
        ...
        if (Intent.ACTION_SEARCH.equals(action))
        {
            ...
            logger.info("Jitsi class Intent.ACTION_SEARCH.equals(action) not null "
            );
        ...
        //        || ACTION_SHOW_CHAT.equals(action))
        {
            ...
            logger.info("Jitsi class showContactsFragment(intent)l ");
       ...
       if(!AndroidUtils.isTablet())
        {
            ...
            logger.info("Jitsi class showContactsFragment not AndroidUtils.isTablet" );
        }
        else
        {
            ...
            logger.info("Jitsi class showContactsFragment is AndroidUtils.isTablet "
                    + chatID);
            ...
            if(chatID != null)
            {
                ...
                logger.info("Jitsi class chatid "
                        + chatID);
            }
        }
