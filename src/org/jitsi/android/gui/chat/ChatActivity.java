    ...
    implements OnPageChangeListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        logger.info("Current activity is chat Activity and it is on Oncreate ");
        ...
        if(savedInstanceState == null)
        {
            ...
            logger.info("Current activity is chat Activity and saveinstancestate is null ");
            // OTR menu padlock
    ...
    private void handleIntent(Intent intent, Bundle savedInstanceState)
    {
        ...
        if(savedInstanceState != null)
        {
            ...
            logger.info("Current activity is chat Activity and in handleintent savedInstanceState not null chatid is "+chatId);
        }
        else
        {
            chatId = intent
            ...
            logger.info("Current activity is chat Activity and in handleintent savedInstanceState null chatid is "+chatId);
