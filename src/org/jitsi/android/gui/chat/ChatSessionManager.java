...
public class ChatSessionManager
{
    ...
    private synchronized static String addActiveChat(ChatSession chatSession)
    {
        ...
        logger.info("mychange Current class is chatsessionManager and in addAvctiveChat key is "+key);
    ...
    public synchronized static void removeActiveChat(ChatSession chatSession)
    {
        ...
        logger.info("mychange Current class is chatsessionManager and in removeAvctiveChat chatid "+chatSession.getChatId());
