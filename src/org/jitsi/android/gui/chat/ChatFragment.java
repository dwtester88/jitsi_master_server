    ...
    extends OSGiFragment
{
                                ...
                                Bundle savedInstanceState)
    {
        ...
        logger.info("mychange current chatid is "+arguments.getString(ChatSessionManager.CHAT_IDENTIFIER));
                    ...
                    TypingNotificationsListener
    {
        ...
        private void addMessageImpl( ChatMessage newMessage, boolean update)
        {
            ...
            //mychange to get the received message
            String receivedmessage = newMessage.getMessage();
            logger.info("mychange received message is "+receivedmessage);
        ...
        public void messageReceived(final MessageReceivedEvent evt)
        {
            ...
            logger.info(" mychange Message received on ChatFragmennt " + ChatMessageImpl.getMsgForEvent(evt).getMessage());

            if (logger.isTraceEnabled())
                logger.trace("MESSAGE RECEIVED from contact: "
                + evt.getSourceContact().getAddress());

            logger.info("mychange MESSAGE RECEIVED from contact: "+ evt.getSourceContact().getAddress());
