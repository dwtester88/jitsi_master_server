               ...
               UIGroupRenderer
{
    ...
    public Object getGroup(int groupPosition)
    {
        ...
        //mychange logging for information
        //logger.info("mychange MetaContactListAdapter "+groups.get(groupPosition).getMetaUID());
    ...
    public int getGroupCount()
    {
        ...
        //mychange logging for information
        //logger.info("mychange groupcount is " +groups.size());
    ...
    public int getChildrenCount(int groupPosition)
    {
        ...
        //mychange logging for information
        //logger.info("mychange groupcount in childencount is " +getContactList (groupPosition).size());
