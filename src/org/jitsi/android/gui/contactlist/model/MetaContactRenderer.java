...
{
    //mychange adding arraylist to store metacontact of all users and adding Looger for logs
    public static ArrayList<MetaContact> contactsmetacontact = new ArrayList<MetaContact>();
    private final net.java.sip.communicator.util.Logger logger
            = net.java.sip.communicator.util.Logger.getLogger(MetaContactRenderer.class);
